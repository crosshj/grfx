export default {
	...
	fileNew: new URL(import.meta.url).href + '/../forms/fileNew.hbs',
	fileOpen: new URL(import.meta.url).href + '/../forms/fileOpen.hbs',
	fileSaveAs: new URL(import.meta.url).href + '/../forms/fileSaveAs.hbs',
	filter: new URL(import.meta.url).href + '/../forms/filter.hbs',
